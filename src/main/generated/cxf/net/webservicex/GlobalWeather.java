 ...
 * 2015-11-30T07:42:33.578-03:30
 * Generated source version: 3.1.4
 * 
 */
@WebServiceClient(name = "GlobalWeather", 
                  wsdlLocation = "file:/C:/Projects/GitHub/spring-cxf/src/main/resources/globalweather.wsdl",
...
public class GlobalWeather extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Projects/GitHub/spring-cxf/src/main/resources/globalweather.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GlobalWeather.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Projects/GitHub/spring-cxf/src/main/resources/globalweather.wsdl");
        }
        WSDL_LOCATION = url;
    }
